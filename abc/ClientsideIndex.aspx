<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientsideIndex.aspx.cs" Inherits="ClientIndex" %>
...
<body class="tm-gray-bg">
	...
	<script type="text/javascript" src="ClientSrc/js/jquery-1.11.2.min.js"></script>      		<!-- jQuery -->
  	<script type="text/javascript" src="ClientSrc/js/moment.js"></script>							<!-- moment.js -->
	<script type="text/javascript" src="ClientSrc/js/bootstrap.min.js"></script>					<!-- bootstrap js -->
	<script type="text/javascript" src="ClientSrc/js/bootstrap-datetimepicker.min.js"></script>	<!-- bootstrap date time picker js, http://eonasdan.github.io/bootstrap-datetimepicker/ -->
