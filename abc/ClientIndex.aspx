<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true"
    CodeFile="ClientIndex.aspx.cs" Inherits="_Default" %>
		...
		<div class="flexslider flexslider-banner">
		  <ul class="slides">
		    <li>
				...
				<img src="ClientSrc/img/banner-1.jpg" alt="Image" />	
		    </li>
		    <li>
			    <div class="tm-banner-inner">
		      ...
		      <img src="ClientSrc/img/banner-2.jpg" alt="Image" />
		    </li>
		    <li>
			    <div class="tm-banner-inner">
		      ...
		      <img src="ClientSrc/img/banner-3.jpg" alt="Image" />
		    </li>
		  </ul>
		</div>	
	</section>
										...
										<div class="form-group">
							          	...
							          	<div class="form-group">
							                <div class='input-group date' id='datetimepicker1'>
							                    <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Check-in Date"></asp:TextBox>

							                    <asp:ImageButton ID="ImageButton1" runat="server" Height="41px" 
                                                    ImageUrl="~/src/images/cal.png" onclick="ImageButton1_Click" Width="49px" ImageAlign = "AbsBottom"></asp:ImageButton>

							                </div>
							                <asp:Calendar ID="Calendar1" runat="server" 
                                                onselectionchanged="Calendar1_SelectionChanged" BackColor="White" 
                                                Visible ="false" height="50px" Width="50px" TodayDayStyle-BackColor="#66FFFF" 
                                                TodayDayStyle-BorderStyle="Dotted" FirstDayOfWeek="Monday" 
                                                ondayrender="Calendar1_DayRender">
<TodayDayStyle BackColor="#66FFFF" BorderStyle="Dotted"></TodayDayStyle>
						            ...
						            <div class="form-group tm-yellow-gradient-bg text-center">
                                        <asp:Button ID="Button1" runat="server" Text="Button" class="tm-yellow-btn" 
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-center">
					<img src="ClientSrc/img/index-01.jpg" alt="image" class="img-responsive">
					<a href="#">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-right">
					<img src="ClientSrc/img/index-02.jpg" alt="image" class="img-responsive">
					<a href="#">
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">						
						<img src="ClientSrc/img/index-03.jpg" alt="image" class="img-responsive">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">						
					    <img src="ClientSrc/img/index-04.jpg" alt="image" class="img-responsive">
						<h3>Proin Gravida Nibhvel Lorem Quis Bind</h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">						
					    <img src="ClientSrc/img/index-05.jpg" alt="image" class="img-responsive">
						<h3>Proin Gravida Nibhvel Lorem Quis Bind</h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2 tm-home-box-2-right">						
					    <img src="ClientSrc/img/index-06.jpg" alt="image" class="img-responsive">
						<h3>Proin Gravida Nibhvel Lorem Quis Bind</h3>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="ClientSrc/img/index-07.jpg" alt="image" class="img-responsive">	
						</div>						
			     ...
			     <div class="col-lg-6">
			        <div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="ClientSrc/img/index-08.jpg" alt="image" class="img-responsive">	
						</div>						
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Proin gravida nibhvell velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum</p>
					        <div class="tm-home-box-2-container">
				...
				<div class="col-lg-6">
				    <div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="ClientSrc/img/index-09.jpg" alt="image" class="img-responsive">	
						</div>						
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Proin gravida nibhvell velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum</p>
					        <div class="tm-home-box-2-container">
			    ...
			    <div class="col-lg-6">
			        <div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="ClientSrc/img/index-10.jpg" alt="image" class="img-responsive">	
						</div>						
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Proin gravida nibhvell velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum</p>
					        <div class="tm-home-box-2-container">
