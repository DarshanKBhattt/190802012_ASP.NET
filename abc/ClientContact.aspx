<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true"
    CodeFile="ClientContact.aspx.cs" Inherits="_Default" %>
    ...
    <body>
		...
		<div class="flexslider flexslider-banner">
		  <ul class="slides">
		    <li>
				...
				<img src="ClientSrc/img/banner-3.jpg" alt="Banner 3" />	
		    </li>		    
		  </ul>
		</div>	
	</section>
		...
		<div class="row">
			...
			<div class="flexslider effect2 effect2-contact tm-contact-box-1">
				<ul class="slides">
					<li>
						<img src="ClientSrc/img/world-map.png" alt="image" class="contact-image" />
